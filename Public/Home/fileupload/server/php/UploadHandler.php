...
|| ($type == "image/jpg") )
    ...
    public function url_encode($str) {  
        if(is_array($str)) {  
            foreach($str['files'] as $key=>$value) {  
                $str['files'][$key]->name = urlencode($value->name);  
            }  
        } else {  
            $str = urlencode($str);  
        }  
    ...
    public function generate_response($content, $print_response = true) {
        ...
        if ($print_response) {
            ...
            $json = urldecode((json_encode($this->url_encode($content))));
