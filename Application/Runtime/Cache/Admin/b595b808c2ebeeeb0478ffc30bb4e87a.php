...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="/Public/Admin/img/user.png" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                  <span class="block m-t-xs"><strong class="font-bold"><?php echo ($account); ?></strong></span>
                    ...
                    <li><a href="#"><i class="fa fa-home"></i><span class="nav-label">主页</span><span class="fa arrow"></span></a>
                     ...
                     <li><a href="#"><i class="fa fa-dollar"></i><span class="nav-label">订单管理</span><span class="fa arrow"></span></a> 
                      <ul class="nav nav-second-level"> 
                         <li><a class="J_menuItem" href="<?php echo U('Admin/Orders/orderList');?>">订单列表</a></li>
                         
                      </ul>
                    </li>
                    <li><a href="#"><i class="fa fa-bank"></i><span class="nav-label">商品管理</span><span class="fa arrow"></span></a> 
                      <ul class="nav nav-second-level"> 
                        <li><a class="J_menuItem" href="<?php echo U('Admin/Goods/goodsList');?>">商品列表</a></li>
                        <li><a class="J_menuItem" href="<?php echo U('Admin/Goods/goodsAdd');?>">添加商品</a></li>
                      </ul>
                    </li>
                    <li><a href="#"><i class="fa fa-users"></i><span class="nav-label">会员管理</span><span class="fa arrow"></span></a> 
                      <ul class="nav nav-second-level"> 
                        <li><a class="J_menuItem" href="<?php echo U('Admin/User/userList');?>">会员列表</a></li>
                      </ul>
                    </li>
                    <li><a href="#"><i class="fa fa-user-secret"></i><span class="nav-label">管理员管理</span><span class="fa arrow"></span></a> 
                      <ul class="nav nav-second-level"> 
                        <li><a class="J_menuItem" href="<?php echo U('Admin/Admin/adminList');?>">管理员列表</a></li>
                        <li><a class="J_menuItem" href="<?php echo U('Admin/Admin/adminAdd');?>">添加管理员</a></li>
                      </ul>
                    </li>
                </ul>
            </div>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2018 <a href="javascript:;" target="_blank">PHPer-Zero</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
